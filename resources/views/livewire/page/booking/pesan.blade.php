                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="form-group col-md-6 mt-0 pr-0">
                                    <label for="wasit">Tambahan Wasit  <strong class="text-danger">(Jika dibutuhkan)</strong></label>
                                    <select class="custom-select" id="wasit">
                                        <option value="">Pilih jumlah wasit</option>
